...
function AboutUsSection() {
  return (
    <div className="flex flex-col items-center justify-center py-6 lg:py-[10rem]  px-[30px] ">
      <div className="text-center max-w-[60rem]">
        <button className="bg-[rgba(0,7,182,0.04)] text-gray-700 lg:mb-4 text-[10px] px-6 py-2 font-semibold rounded-full sm:text-[10px] lg:text-lg  hover:bg-orange-600 transition">
          ABOUT US
        </button>
        
        <p className="text-[rgba(0,0,0,0.72)] text-[16px] px-leading-relaxed py-10  sm-text-[16px]  lg:mb-20 lg:text-[20px] ">
